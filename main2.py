...
if uploaded_file is not None:
    try:
        ...
        with tab1:
            ...
            with col2:
                ...
                fig_activity = px.pie(
                    ...
                    color_discrete_sequence=['#FF6B6B', '#FFE66D', '#4ECDC4', '#95E1D3', '#F38181'],
                    height=300
                )
                fig_activity.update_layout(margin=dict(t=30, b=0, l=0, r=0), showlegend=True)
                st.plotly_chart(fig_activity, width='stretch', config={'responsive': True, 'displayModeBar': False, 'staticPlot': False})
        ...
        with tab2:
            ...
            fig_temp.update_layout(plot_bgcolor='rgba(255, 107, 107, 0.1)', paper_bgcolor='rgba(0,0,0,0)', margin=dict(l=0, r=0, t=30, b=0))
            st.plotly_chart(fig_temp, width='stretch', config={'responsive': True, 'displayModeBar': False})
            ...
            with col1:
                ...
                st.plotly_chart(fig_hr, width='stretch', config={'responsive': True, 'displayModeBar': False})
            ...
            with col2:
                ...
                st.plotly_chart(fig_oxygen, width='stretch', config={'responsive': True, 'displayModeBar': False})
            ...
            st.plotly_chart(fig_sleep, width='stretch', config={'responsive': True, 'displayModeBar': False})
        ...
        with tab3:
            ...
            st.plotly_chart(fig_corr, width='stretch', config={'responsive': True, 'displayModeBar': False})
            ...
            with col1:
                ...
                st.plotly_chart(fig_s1, width='stretch', config={'responsive': True, 'displayModeBar': False})
            ...
            with col2:
                ...
                fig_s2 = px.scatter(
                    ...
                    height=350,
                    color_discrete_map={0: "#1c8562", 1: '#ef4444'},
                    labels={'SleepPatterns': 'Sleep (hrs)', 'BloodOxygen': 'O2 (%)'}
                )
                st.plotly_chart(fig_s2, width='stretch', config={'responsive': True, 'displayModeBar': False})
...
st.markdown("---")
st.markdown("<p style='text-align: center; color: Black;'> Made by Antra Patel</p>", unsafe_allow_html=True)